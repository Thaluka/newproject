        ...
        <div class="sidebar-wrapper" >
            <ul class="sidebar-nav mt-3" >
               <li>
                ...
                <li>
                    <a href="{{url('/buydetails_products/create')}}">Purchase Product Details</a>
                </li>

               

                <li>
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">New Products</a>
                ...
                <div class="card-body">
                 ...
                 @endif
                    ...
                    <br>
                     <div class="row">
                         <diV class="mr-auto">
                             <a href="/addpart/create" class="btn btn-default">Go to add</a>
                         </div>
                         <div class="ml-auto">
                             {{$parts->links()}}
                         </diV>

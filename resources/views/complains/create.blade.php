        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                     ...
                     <div class="col-md-12">
                     <form method="post" action="{{ action('ComplainsController@store') }}"   class="form-horizontal mt-4">
                  {{csrf_field()}}
                   <div class="form-group row  {{ $errors->has('title') ? 'has-error' : '' }} ">
                        <label for="firstname" class="col-form-lable-sm col-sm-3">First Name</label>
                        <div class="col-sm-8">
                        	  <input type="text" class="form-control"  name="title" value="{{old('title')}}" placeholder="Enter your first name" autofocus>
                        	  @if ($errors->has('title'))
                   ...
                   <div class="form-group row  {{ $errors->has('body') ? 'has-error' : '' }} ">
                        ...
                        <div  class="col-sm-8" >
                        	<input type="text" class="form-control" name="body" value="{{old('body')}}" placeholder="Enter your last name"  autofocus>
                        	@if ($errors->has('body'))
                                    <span class="help-block" >

...
<br/>
    ...
    <div class="container logform col-lg-8 mt-3">
        <div class="card-header row">
             ...
             <div  class="card-body ">
             <form method="POST" action="{{  action('TechnicianController@destroy',$technician->email) }}"  class="form-horizontal mt-4">
                  {{csrf_field()}}    {{method_field('PUT')}}
                   ...
                   <div class="form-group row mt-0 mb-0">
                             <div  class="col-sm-6 offset-sm-3">
                        	       <button type="submit" class="col-sm-6  btn-primary btn-sm btn-block ">Confirm Delete</button>
                             </div>
                             <div  class="col-sm-4">
                                   <a href="/technicians" class="btn btn-default col-sm-6  btn-primary btn-sm btn-block ">Cancel</a>
                             </div>
                        </div>
             </form>
             </div>

...
{{-- <body background="{{ asset('images/14.jpg')}}"> --}}
    ...
    <div class="collapse navbar-collapse mr-2" id="navbarTogglerDemo01">
        ...
        <li class="nav-item active mr-2">
            <a class="nav-link mr-2" href="/supervisor"><b>Home </b><span class="sr-only">(current)</span></a>
        </li>
        </ul>
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <div class="sidebar-wrapper" style="max-height: 540px">
            <ul class="sidebar-nav mt-3" >
               
                <li>

                    <a href="{{url('/complains')}}">New Complaints</a>
                    <a href="{{url('/viewassign')}}">Assigned Complaints</a>
